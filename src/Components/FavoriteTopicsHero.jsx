        ...
        <div className='fav_card_one mb-7'>
                ...
                <div key={''} className='flex flex-col  shadow-2xl rounded-2xl border-1 border-gray-200'>
                    ...
                    <div className='flex pl-7 pt-3'>
                        <div className=''>
                            <img className=' h-[30px] w-[30px] bg-black rounded-lg self-center' src={blogggs.content_author_picture} alt="" />
                        </div>

                        <h4 className='overflow-hidden truncate self-center pl-2'>{blogggs.content_author_name}</h4>
                    </div>
                    
                    <div className='title_content_authorImg_author_time_bookmark  overflow-hidden'>
                        <h1 className='font-extrabold overflow-hidden pl-2 '>{ blogggs.content_title }</h1>
                        <p className='overflow-hidden pl-2 pr-2'>{blogggs.content_text}</p>
                    </div>
                    ...
                    <div className='grid grid-cols-2 auto-rows-auto ml-2 mt-4 mb-4 '>
                        <p className='font-extralight'>{blogggs.content_posted_date}</p>
