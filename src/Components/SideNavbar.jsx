...
const SideNavbar = () => {
  return (
      <div className='side-nav-bar !important fixed bg-transparent backdrop-blur-3xl'>
          <div className='h-[60px] w-[5vw] absolute overflow-hidden flex flex-col pt-4 border-solid border-r-4 border-gray-100 cursor-pointer '>
            <FaLeaf className='  h-[40px] w-[40px] place-self-center'/>
          </div>
          <div className='h-[100vh] w-[5vw] flex flex-col justify-center border-solid border-r-4 border-gray-100 '>
